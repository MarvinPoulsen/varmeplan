...
import { villagesMinimapId } from '../../config';
...
const VillagesPage: FC = () => {
    ...
    const onMapReady = (mm) => {
        ...
        const ds = ses.getDatasource('ds_varmeplan_vi_landsbyer_view');
        ...
        const dsArea = ses.getDatasource('ds_varmeplan_landsbyer_varmeplan');
    ...
    const filteredByArea =
        VillagesData.length > 0 ? (area ? VillagesData.filter((item) => item.navn === area) : VillagesData) : [];
